...
const songs = [
  {
    ...
    img: "../assets/artist_images/Arijit Singh.jpeg",
    music: "../assets/Hindi/ChannaMereya.mp3",
  },
  {
    artistName: "Ed Sheeran",
    songName: "Shape Of You",
    img: "../assets/artist_images/Ed Sheeran.jpeg",
    music: "../assets/English/ShapeOfYou.mp3",
  },
  {
    artistName: "Selena Gomez",
    songName: "No Tears Left to Cry ",
    img: "../assets/artist_images/Selena Gomez.jpeg",
    music: "../assets/English/NoTearsLeft.mp3",
  },
  {
    artistName: "Mohit Chauhan",
    songName: "Tum Se hi Mereya",
    img: "../assets/artist_images/Mohit Chauhan.jpeg",
    music: "../assets/Hindi/TumHiHo.mp3",
  },

  {
    artistName: "Olivia Rodrigo",
    songName: "Vampire",
    img: "../assets/artist_images/Olivia Rodrigo.jpeg",
    music: "../assets/English/Vampire.mp3",
  },
  {
    artistName: "Arijit Singh",
    songName: "Tum Hi Ho",
  ...
  },
  {
    ...
    songName: "Say Don't Let Go",
    img: "../assets/artist_images/Taylor swift.jpeg",
    music: "../assets/English/SayDontLetGo.mp3",
  },
];
...
function loadTrack(trackIndex) {
  currentTrack.setAttribute("src", songs[trackIndex].music);
  currentTrack.load();
...
function fulltime() {
  ...
  const secs = String(Math.floor(currentTrack.duration - mins * 60)).padStart(
    2,
    "0"
  );

  const currMins = String(Math.floor(currentTrack.currentTime / 60)).padStart(
    2,
    "0"
  );
  const currSecs = String(
    Math.abs(Math.floor(currMins * 60 - currentTrack.currentTime))
  ).padStart(2, "0");
...
function volume() {
  currentTrack.volume = vol.value / 10; // Fix the division by 11
}
function seek() {
  currentTrack.currentTime = parseFloat(trackRange.value); // Convert to number
}
